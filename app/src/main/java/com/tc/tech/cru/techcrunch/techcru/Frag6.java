...
import com.tc.tech.cru.techcrunch.techcru.databinding.FragmentFrag6Binding;

public class Frag6 extends Fragment {

    FragmentFrag6Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentFrag6Binding.inflate(inflater, container, false);
...
//        binding.shimmer.setVisibility(View.VISIBLE);
        ...
        viewModel.urlsWeb("https://techcrunch.com/category/apps/");
